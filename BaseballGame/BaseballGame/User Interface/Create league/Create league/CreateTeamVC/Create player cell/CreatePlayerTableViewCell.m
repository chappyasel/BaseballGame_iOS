...
@implementation CreatePlayerTableViewCell
...
- (IBAction)detailsButtonPressed:(UIButton *)sender {
    [self.delegate shouldBeginEditingCusomPlayer: self.customPlayer];
}
