...
- (void)loadTeamWithAbbrev: (NSString *) abbrev andYear: (NSNumber *) year {
    ...
    [team loadTeamFromAbbreviation: abbrev];
    team.year = year;
    ...
    NSURL *url = [NSURL URLWithString: [NSString stringWithFormat:@"http://baseball-reference.com/teams/%@/%@-organization-batting.shtml",abbrev,year]];
    ...
    url = [NSURL URLWithString: [NSString stringWithFormat:@"http://baseball-reference.com/teams/%@/%@-organization-pitching.shtml",abbrev,year]];
